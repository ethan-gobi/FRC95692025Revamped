...
/**
 * Ejects coral while respecting elevator level for motor speed decisions.
 */
public class CoralEjectCommand extends Command {
  ...
  @Override
  public void execute() {
    int level = elevatorSubsystem.getLevel();
    if (level <= 1) {
  ...
  public boolean isFinished() {
    return coralEndeffactorSubsystem.beamBroken2();
  }
}
